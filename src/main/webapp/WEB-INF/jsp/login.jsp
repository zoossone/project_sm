        ...
        <article id="password">
            ...
            <form method="post" action="#">
                ...
                <div class="field half">
                    <label for="demo-ID">ID</label> <input type="text" name="demo-ID"
                                                           id="demo-ID" value="" placeholder="ID"/>
                </div>
                <div class="field half first">
                    <label for="demo-no">Email</label> <input type="text"
                                                              name="demo-no" id="demo-no" value="" placeholder="Email"/>
                </div>
                <div class="field half">
                    <label for="btn"><br></label> <input type="button" id="btn"
                                                         value="Email 인증"/>
                </div>
                <br/> <br/>
